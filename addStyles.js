...
bodyClass.split(" ").forEach((cls)=>calcBody.classList.add(cls));

const outputClass= "flex flex-col w-3/4 h-12 jusitfy-center items-end m-1 bg-gray-300 text-gray-900 font-semibold px-2 border border-black hover:border-gray-500 rounded";
...
function addClasses(button){
    ...
    const baseClass= "flex w-12 h-12 jusitfy center items-center m-1 font-bold py-2 px-2 border hover:border-transparent rounded text-white border-2 text-2x1";
